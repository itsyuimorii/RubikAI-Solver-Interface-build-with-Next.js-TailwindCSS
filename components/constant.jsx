...
export const CUBE_ROTATION_INSTRUCTIONS = [
    ...
    ' Step 04: Rotate the cube to show the 🟡 yellow face directly to the camera with 🟢 green face on top',

    ' Step 05: Rotate the cube to show the ⚪️ white face directly to the camera with  🔵 blue face on top.',
